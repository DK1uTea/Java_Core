...
public class StaffLoginView {
    ...
    public StaffLoginView(CourseRegisterController courseRegisterController) {
    ...
    public void showLoginView(){
        ...
        loginButton.setOnAction(e -> courseRegisterController.handleStaffAfterLogin(usernameInput.getText(), passwordInput.getText()));
