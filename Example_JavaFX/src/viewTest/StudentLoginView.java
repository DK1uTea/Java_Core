...
public class StudentLoginView {
    ...
    public StudentLoginView(CourseRegisterController courseRegisterController) {
    ...
    public void showLoginView(){
        ...
        loginButton.setOnAction(e -> courseRegisterController.handleStudentAfterLogin(usernameInput.getText(), passwordInput.getText()));
